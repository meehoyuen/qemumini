...
static void vga_update_memory_access(VGACommonState *s)
{
    ...
    if ((s->sr[0x02] & 0xf) == 0xf && s->sr[0x04] & 0x08) {
        ...
        base += isa_mem_base;
        region = (MemoryRegion *)malloc(sizeof(*region));
                          ...
                          const MemoryRegionPortio **vbe_ports)
{
    ...
    *vbe_ports = vbe_portio_list;
    ...
    vga_mem = (MemoryRegion *)malloc(sizeof(*vga_mem));
              ...
              MemoryRegion *address_space_io, bool init_vga_ports)
{
    ...
    PortioList *vga_port_list = (PortioList *)malloc(sizeof(PortioList));
    PortioList *vbe_port_list = (PortioList *)malloc(sizeof(PortioList));
