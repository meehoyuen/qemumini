...
static x86_def_t builtin_x86_defs[] = {
    {
        ...
        .xlevel = 0x8000000A,
        //.model_id = "Intel(R) Core(TM) i9-9900K @ 3.60GHz",
        .model_id = "Intel(R) Core(TM) i5-8265U CPU @ 1.60GHz",
    },
    {
        .name = "phenom",
        .level = 5,
...
{
    x86_def_t *def = calloc(1, sizeof (x86_def_t));
