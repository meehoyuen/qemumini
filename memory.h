 ...
 */
void memory_region_set_offset(MemoryRegion *mr, uint64_t offset);
 ...
 *          %DIRTY_MEMORY_VGA.
 */
bool memory_region_get_dirty(MemoryRegion *mr, uint64_t addr,
                             unsigned client);
 ...
 */
void memory_region_set_dirty(MemoryRegion *mr, uint64_t addr);
 ...
 *          %DIRTY_MEMORY_VGA.
 */
void memory_region_reset_dirty(MemoryRegion *mr, uint64_t addr,
                               uint64_t size, unsigned client);
