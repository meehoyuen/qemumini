...
static void flatview_insert(FlatView *view, unsigned pos, FlatRange *range)
{
    if (view->nr == view->nr_allocated) {
        ...
        view->ranges = realloc(view->ranges,
...
void memory_region_add_coalescing(MemoryRegion *mr,
                                  ...
                                  uint64_t size)
{
    CoalescedMemoryRange *cmr = (CoalescedMemoryRange *)malloc(sizeof(*cmr));
                               ...
                               int fd)
{
    ...
    ++mr->ioeventfd_nb;
    mr->ioeventfds = realloc(mr->ioeventfds,
